...
def upgrade():
    ...
    op.create_table('huts_album',
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('type', sa.Enum('bedroom', 'bathroom', 'living_room',
                              'kitchen', 'other_picture', name='type'), nullable=True),
                    sa.Column('image_url', sa.String(), nullable=False),
                    sa.Column('hut_id', sa.Integer(), nullable=True),
                    sa.ForeignKeyConstraint(['hut_id'], ['hut.id'], ),
                    sa.PrimaryKeyConstraint('id')
