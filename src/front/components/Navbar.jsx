    ...
    <nav className="relative text-xl">
      <ul className="flex justify-between items-center bg-black/90 py-3 px-3 md:px-5 lg:px-16">
        ...
        <div className="hidden md:flex md:items-center md:gap-8 md:ml-auto">
          ...
          <li>
            <Link to="/" className="hidden md:block hover:scale-105 hover:text-brown-250 transition">Reservas</Link>
          </li>
          <li>
            <Link to="/" className="hidden md:block hover:scale-105 hover:text-brown-250 transition">Favoritos</Link>
          </li>
          <li>
            <Link to="/" className="hidden md:block hover:scale-105 hover:text-brown-250 transition">Contacto</Link>
          </li>
          <li>
            <Link to="/" className="hidden md:block hover:scale-105 hover:text-brown-250 transition">Mi Perfil</Link>
          </li>
        </div>
        <li className="md:ml-14">
          <Link to="/" onClick={handleConnected}>
            {
              !isConnected ?
      ...
      {
        menuIsActive && (
          <div className="bg-black w-full min-h-screen absolute z-50 text-3xl font-bold md:hidden">
