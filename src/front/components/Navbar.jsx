...
export const Navbar = () => {
  ...
  const handleLogout = (e) => {
    ...
    // Si no hay sesión activa (isLogged = false), no hacemos nada especial
    // y se permite la navegación normal al login
  };
