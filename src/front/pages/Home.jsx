...
export const Home = () => {
	...
	return (
		<div className="relative min-h-screen space-y-5">
			<div className="ml-10 my-10 md:absolute md:left-5">
			...
			<article className="flex justify-center my-5">
				<div className="bg-gradient-to-br from-green-550 to-green-350/80 p-5 rounded-3xl md:absolute md:bottom-40 md:left-10 lg:bottom-5 lg:left-1/2 lg:-translate-x-1/2 gap-5 w-[300px] text-center">
					<h3>Opiniones de nuestros clientes</h3>
				</div>
			</article>
			<article className="flex mx-auto flex-col bg-gradient-to-br from-green-550 to-green-350/80 md:bg-green-150/20 p-5 rounded-3xl md:absolute md:bottom-5 md:right-5 gap-5 w-[300px]">
			...
			<article className="absolute bottom-5 left-1/2 -translate-x-1/2 md:left-1/4 lg:left-40 lg:pl-5">
